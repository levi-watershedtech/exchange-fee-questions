...
*Effective 2026-07-01. Source: https://www.cboe.com/us/options/membership/fee_schedule/edgx/*
...
The ORF is assessed by EDGX Options to each Member on each side of a transaction for options transactions cleared by the Member that are cleared by The Options Clearing Corporation (OCC) in the “customer” range for executions that occur on EDGX Options. The fee is collected by OCC on behalf of EDGX Options from the Clearing Member that was the clearing firm for the transaction or non-Member that was the clearing firm, where a Clearing Member was the executing clearing firm for the transaction. The ORF is not assessed on outbound linkage trades. Pursuant to EDGX Options Rule 24.1, solely for purposes of ORF billing, Members must provide EDGX Options with a complete list of its OCC clearing numbers and keep such information up to date with EDGX Options.

| Options Regulatory Fee (ORF) | Fee Per Executed Contract Side |
| --- | --- |
| All Classes | $0.00286 per contract side |
