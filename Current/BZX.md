...
| Customer | PY | * ($0.25) * ($0.35) * ($0.47) * ($0.49) * ($0.50) * ($0.52) | PC | * $0.48 * $0.46 | NY | * ($1.05) | NC | $0.85 |
| Professional | PA | * ($0.25) * ($0.42) * ($0.44) * ($0.46) * ($0.48) | PP | * $0.50 | NA | ($0.65) | NP | * $1.15 |
| Firm/BD/JBO | PF | * ($0.26) |  |  | NF | * ($0.30) |
| Market Maker | PM (Excluding SPY) | * ($0.29) * ($0.32) * ($0.35) * ($0.38) * ($0.41) * ($0.42) |  |  | NM | * ($0.40) * ($0.45) * ($0.54) * ($0.88) |
|  | PM (SPY) | * ($0.29) * ($0.33) * ($0.36) * ($0.38) * ($0.42) * ($0.43) * ($0.45) |  |  |  |  |
| Away Market Maker | PN | * ($0.26) |  |  | NN | * ($0.30) |
...
| --- | --- | --- |
| BC | Adds or removes liquidity (Customer), RUT | 0.15 |
| BM | Adds or removes liquidity (MM), RUT | 0.35 |
| BN | Adds or removes liquidity (Non-Customer/Non-MM), RUT | 0.55 |
| BO | Trades on the Open, RUT | Free |
| GC | Routed (Customer), RUT | 0.85 |
| GM | Routed (MM), RUT | 1.05 |
| GN | Routed (Non-Customer/Non-MM), RUT | 1.25 |
...
| NM | Adds liquidity (MM), Non-Penny | (0.40) |
| NN | Adds liquidity (Away MM), Non-Penny | (0.30) |
| NP | Removes liquidity (Non-Customer), Non-Penny | 1.15 |
| NY | Adds liquidity (Customer), Non-Penny | (1.05) |
| OC | Complex Trades at the Open | Free |
| OO | BZX Options Opening | Free |
| PA | Adds liquidity (Pro), Penny Program | (0.25) |
| PC | Removes liquidity (Customer) Penny Program | 0.48 |
| PF | Adds liquidity (Firm/BD/JBO), Penny Program | (0.26) |
| PM | Adds liquidity (MM), Penny Program | (0.29) |
| PN | Adds liquidity (Away MM), Penny Program | (0.26) |
| PP | Removes liquidity (Non-Customer), Penny Program | 0.50 |
| PY | Adds liquidity (Customer), Penny Program | (0.25) |
| RN | Routed (Non-Customer), Penny Program | 0.90 |
| RO | Routed (Non-Customer), Non-Penny | 1.25 |
| RP | Routed (Customer) to AMEX, BOX, Cboe, EDGX, MIAX, SPHR or PHLX (excl SPY to PHLX) | 0.25 |
| RQ | Routed (Customer) to ARCA, BX, C2, ISE, GMNI, MERC,EMLD, PERL, NOM, or MEMX, Penny Program (incl SPY to PHLX) | 0.85 |
| RR | Routed (Customer) to ARCA, BX, C2, ISE, GMNI, MERC,EMLD, PERL, NOM or MEMX, Non-Penny | 1.25 |
| ZA | Complex order, Customer (contra Non-Customer), Penny | (0.40) |
...
| ZE | Simple Order Trades with Complex Order | Free |
| ZF | Complex order, adds liquidity, Non-Customer, Non-Market Maker, Penny | 0.50 |
| ZG | Complex order, removes liquidity, Non-Customer, Penny | 0.50 |
| ZH | Complex order, adds liquidity, Non-Customer, Non-Penny | 0.90 |
| ZI | Complex order, adds liquidity, Market Maker, Penny | 0.50 |
| ZJ | Complex order, removes liquidity, Non-Customer, Non-Penny | 0.90 |
| ZO | Complex order legs into Simple Book, Non-Customer, Penny | Free |
| ZP | Complex order legs into Simple Book, Non-Customer, Non-Penny | Free |
...
1. ### Customer Penny Add Volume Tiers
   ...
   | --- | --- | --- |
   | Tier 1 | ($0.35) | Member has an ADAV in Simple Customer orders ≥ 0.05% of average OCV |
   | Tier 2 | ($0.47) | 1. Member has an ADV in Simple orders ≥ 1.00% of average OCV; or 2. Member has an ADAV in Simple Customer orders ≥ 0.30% of average OCV |
   | Tier 3 | ($0.49) | 1. Member has an ADAV in Simple Customer orders ≥ 0.20% of average OCV; and 2. Member has an ADAV in Simple Market Maker orders ≥ 0.25% of average OCV |
   | Tier 4 | ($0.50) | Member has an ADAV in Simple Customer orders ≥ 1.00% of average OCV |
   | Tier 5 | ($0.52) | Member has an ADAV in Simple Customer orders ≥ 1.75% of average OCV |
   | Customer Cross-Asset Add Tier 1 | ($0.50) | 1. Member has an ADAV in Simple Customer orders ≥ 0.50% of average OCV; and 2. Member has on BZX Equities an ADAV ≥ 0.35% of average TCV, excluding sub-dollar securities |
   | Customer Cross-Asset Add Tier 2 | ($0.52) | 1. Member has an ADAV in Simple Market Maker orders ≥ 0.25% of average OCV; and 2. Member has on BZX Equities an ADAV ≥ 0.45% of average TCV, excluding sub-dollar securities |
2. ### Customer Penny Take Volume Tier

   Applicable to fee code PC.

   | Tier | Fee Per Contract to Remove | Required Criteria |
   | --- | --- | --- |
   | Tier 1 | $0.46 | Member has an ADAV in Simple orders ≥ 1.00% of average OCV |
3. ### Reserved
4. ### Reserved
5. ### Orders Submitted with a Designated Give Up

   Applicable to fee codes NA, NF, NN, NY, PA, PC, PF, PN, PY, ZA, ZB and ZF.
...
6. ### Market Maker Penny Add Volume Tiers
   ...
   | Tier | Rebate Per Contract to Add (excluding SPY) | Rebate Per Contract to Add (SPY) | Required Criteria |
   | --- | --- | --- | --- |
   | Tier 1 | ($0.32) | ($0.33) | Member has an ADAV in Simple Market Maker orders ≥ 0.15% of average OCV |
   | Tier 2 | ($0.35) | ($0.36) | Member has an ADAV in Simple Market Maker orders ≥ 0.20% of average OCV |
   | Tier 3 | ($0.38) | ($0.38) | 1. Member has an ADAV in Simple Market Maker orders ≥ 0.15% of average OCV; and 2. Member has an ADRV in Simple Market Maker orders ≥ 0.75% of average OCV |
   | Tier 4 | ($0.41) | ($0.42) | Member has an ADAV in Simple Market Maker orders ≥ 0.35% of average OCV |
   | Tier 5 | ($0.42) | ($0.45) | Member has an ADAV in Simple Market Maker orders ≥ 0.50% of average OCV |
   | Market Maker Cross-Asset Add Tier | ($0.42) | ($0.43) | 1. Member has an ADAV in Simple Market Maker orders ≥ 0.35% of average OCV; and 2. Member has on BZX Equities an ADAV ≥ 0.40% of average TCV, excluding sub-dollar securities |
7. ### Market Maker Non-Penny Add Volume Tiers
   ...
   | Tier | Rebate Per Contract to Add | Required Criteria |
   | --- | --- | --- |
   | Tier 1 | ($0.45) | Member has an ADAV in Simple Market Maker orders ≥ 0.20% of average OCV |
   | Tier 2 | ($0.54) | Member has an ADAV in Simple Market Maker orders ≥ 0.35% of average OCV |
   |
8. ### Reserved
9. ### Professional Penny Add Volume Tiers
   ...
   | Tier | Rebate Per Contract to Add | Required Criteria |
   | --- | --- | --- |
   | Tier 1 | ($0.42) | Member has an ADAV in Simple Customer and Professional orders ≥ 0.20% of average OCV |
   | Tier 2 | ($0.44) | Member has an ADAV in Simple Customer and Professional orders ≥ 0.25% of average OCV |
   | Tier 3 | ($0.46) | Member has an ADAV in Simple Customer and Professional orders ≥ 0.40% of average OCV |
   | Tier 4 | ($0.48) | Member has an ADAV in Simple Customer and Professional orders ≥ 0.65% of average OCV |
10. ### Complex order Customer (contra Non-Customer) Penny Volume Tiers

    Applicable to fee code ZA.

    | Tier | Rebate Per Contract | Required Criteria |
    | --- | --- | --- |
    | Tier 1 | ($0.43) | Member has an ADV in Complex Customer orders ≥ 0.10% of average OCV |
    | Tier 2 | ($0.45) | 1. Member has an ADV in Complex Customer orders ≥ 0.15% of average OCV; and 2. Member has an ADAV in Market Maker orders ≥ 0.35% of average OCV |
    | Tier 3 | ($0.47) | 1. Member has an ADV in Complex Customer orders ≥ 0.25% of average OCV; and 2. Member has an ADAV in Market Maker orders ≥ 0.35% of average OCV |
11. ### Complex order Customer (contra Non-Customer) Non-Penny Volume Tiers

Applicable to fee code ZB.

| Tier | Rebate Per Contract | Required Criteria |
| --- | --- | --- |
| Tier 1 | ($0.84) | Member has an ADV in Complex Customer orders ≥ 0.10% of average OCV |
| Tier 2 | ($0.88) | 1. Member has an ADV in Complex Customer orders ≥ 0.15% of average OCV; and 2. Member has an ADAV in Market Maker orders ≥ 0.35% of average OCV |
| Tier 3 | ($0.92) | 1. Member has an ADV in Complex Customer orders ≥ 0.25% of average OCV; and 2. Member has an ADAV in Market Maker orders ≥ 0.35% of average OCV |

12. ### Complex order Non-Customer Penny Add Volume Tier

Applicable to fee codes ZF and ZI.

| Tier | Fee Per Contract to Add | Required Criteria |
| --- | --- | --- |
| Tier 1 | $0.49 |  | 1. Member has an ADV in Complex Customer orders ≥ 0.15% of average OCV; and 2. Member has an ADAV in Market Maker orders ≥ 0.35% of average OCV |
...
| Ports with Bulk Quoting Capabilities | * $1,500/month for 1st and 2nd port * $2,500/month for 3rd port or more |
...
| BOE Unitized Logical Port (Set) | * $2,500/month for 1st and 2nd port set * $3,000/month for 3rd - 14th port set * $3,500/month for 15th - 30th port set |
| Bulk Unitized Logical Port (Set) | * $5,500/month for 1st and 2nd port set * $6,000/month for 3rd - 14th port set * $6,500/month for 15th - 30th port set |
| Purge Unitized Logical Port (Set) | * $2,500/month for 1st and 2nd port set * $3,000/month for 3rd - 14th port set * $3,500/month for 15th - 30th port set |
...
* Unitized Logical Ports can be purchased individually, capable of accessing a specified matching unit, or as a Unitized Logical Port Set, providing a set of Unitized Logical Ports across every available Matching Unit on a one-to-one basis. These two structures can be combined for up to a maximum of thirty (30) Unitized Logical Ports per Member, per Matching Unit, per Port Type. As an example, a Member may request twelve (12) BOE Unitized Logical Port Sets and eighteen (18) individual BOE Unitized Logical Ports for Matching Unit 1, providing a total max of thirty (30) BOE Unitized Logical Ports on Matching Unit 1 specifically. This would result in having thirty (30) BOE Unitized Logical Ports on Matching Unit 1 and twelve (12) BOE Unitized Ports on all additional Matching Units as part of the twelve (12) BOE Unitized Logical Port Sets requested. Additionally, a Member may request thirty (30) Bulk Unitized Logical Port Sets and thirty (30) Purge Unitized Logical Port Sets as those would constitute different Port Types.
...
| <=500,000,000 | >500,000,001 | >1,000,000,001 | >1,500,000,001 | >3,000,000,001 |
|  | $0.00 | $0.05 | $0.075 | $0.125 | $0.20 |

|  | Fee | | | | |
| --- | --- | --- | --- | --- | --- |
| ADO Fee Rate per 1,000 ADO | Tier 1 | Tier 2 | Tier 3 | Tier 4 | Tier 5 |
| <=2,000,000 | >2,000,001 | >2,500,001 | >3,000,001 | >3,500,001 |
|  | $0.00 | $1.00 | $1.50 | $2.00 | $2.50 |

* “ADO” represents the total number of orders for the month, divided by the number of trading days. “ADQ” represents the total number of quotes for the month, divided by the number of trading days. When measuring the ADO and ADQ, orders, quotes, cancel/replace modify orders, and quote updates which submit a bid or offer are included. A Member’s ADO and ADQ will be aggregated together with any affiliated Member sharing at least 75% common ownership.
* Each Firm may submit up to 2,000,000 average daily orders or up to 500,000,000 average daily quotes per calendar month without incurring ADO/ADQ fees. In the event that the average number of quotes per trading day during a calendar month submitted exceeds 500,000,000, each incremental usage of up to 20,000 average daily quotes will incur an additional fee as per the table above. Similarly, in the event that the average number of orders per trading day during a calendar month submitted exceeds 2,000,000, each incremental usage of up to 1,000 average daily orders will incur an additional ADO fee as per the table above.
...
* In the event a firm has an odd lot increment (e.g., is not up to the 20,000 ADQ increment or the 1,000 ADO increment), they will not be charged a prorated portion of that increment. For example, if a firm has 1,000,010,000 ADQ, they would be charged based on 50,000 ADQ increments (1,000,000,000/20,000) as the remainder of 10,000 does not hit the 20,000 ADQ increment.
...
### BZX Options Complex Top, Complex Depth, and Complex Auction Feeds:
...
\* Distributors will be subject to the greater of the two Distribution fees when receiving BZX Options Complex Top, Complex Depth, and/or Complex Auction for both Internal and External Distribution. Distributors of any one of the BZX Options Complex Top, Complex Depth, or Complex Auction Feed, may receive, at no additional charge, access to any or all of the other aforementioned Complex Order Feeds.

\*\* Users of any one of the BZX Options Complex Top, Complex Depth, and/or Complex Auction Feeds may receive, at no additional charge, access to any of the other aforementioned Complex Order Feeds.
